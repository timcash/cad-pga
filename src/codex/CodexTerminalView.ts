...
export class CodexTerminalView {
  ...
  public render() {
    document.title = 'Codex Terminal - CAD PGA';
    ...
    this.root.innerHTML = `
      <div class="codex-page-shell codex-page-shell--locked">
        <header class="codex-topbar">
          <a class="codex-back-link" href="../">CAD PGA</a>
          <div class="codex-topbar-copy">
            ...
            <p class="codex-lede">This page is a thin xterm.js client for a local PTY-backed Codex daemon running on this machine or through the <code>codex.dialtone.earth</code> tunnel.</p>
          </div>
        </header>
